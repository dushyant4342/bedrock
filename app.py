...
def get_llama3_llm():
    """Returns Llama3 model (previously named get_claude_llm, but it loads Llama3)."""
...
def get_claude_llm(): 
    """Returns Claude model (Not purchased yet)."""
...
at least 100 words and provide detailed explanations. If you don't know the answer, 
